              ...
              <div className="card-body text-align-left">
                ...
                <div className="input-group mb-1">
                  ...
                  <div className="input-group-append">
                    <button disabled={false} className="btn btn-secondary py-3 hover" type="button" id="donation-button" onClick={()=> this.setState({progress: this.state.progress += this.state.value, donors: this.state.donors + 1, donations: this.state.donations -= this.state.value})}>Give Now</button>
                  </div>
                </div>
            ...
            <div className="card m-4 p-3 ">
              <div className="card-body text-align-left">
                ...
                <div className="input-group mb-1">
                  ...
                  <input type="number" name="donation" value={this.state.value} onChange={this.handleChange.bind(this)} className="form-control py-3 font-weight-bolder" placeholder="$" aria-label="$" aria-describedby="button-addon2" />
                
                  <div className="input-group-append">
                    <button disabled={true} className="btn btn-secondary py-3 hover" type="button" id="donation-button" onSubmit={this.submit.bind(this)}>Give Now</button>
                  </div>
                </div>
